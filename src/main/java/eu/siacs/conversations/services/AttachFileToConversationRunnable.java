...
public class AttachFileToConversationRunnable implements Runnable, TranscoderListener {
    ...
    AttachFileToConversationRunnable(
        ...
        // fork: video compression/transcoding is disabled — send the original file bytes
        // (original name + original metadata) untouched. Restore the stock expression below
        // to bring the built-in transcoder back.
